...
describe FileLine do
  ...
  it "shows a line from file with no context" do
    ...
    FileLine.new(2, file_path).present_contents("MATCH").should == "stuff#{"MATCH".red}stuff"
  end
  ...
  it "shows a line from file with 1 line on each side of context" do
    ...
    contents = "a\nb\nc\n"
    File.write(file_path, contents)
    FileLine.new(2, file_path).present_contents(".+", 1).should == "a\n#{"b".red}\nc"
  end
  ...
  it "handles too much context blowing past end of file" do
    ...
    contents = "a\nb\n"
    File.write(file_path, contents)
    FileLine.new(1, file_path).present_contents(".+", 2).should == "\n\n#{"a".red}\nb\n"
  end
